 ...
 * @author ceiroa
 */
public class VisitLowerExtremitiesServlet extends VisitCustomHttpServlet {
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher =
                getServletContext().getRequestDispatcher(visitLowerExtremitiesJsp);
    ...
    throws ServletException, IOException {
        ...
        //a visit of this type exists for this client
            ...
            iVisit visit = leDB.getVisitByClientID(clientId, tableName, instance);
            if(visit != null) {
                request.setAttribute("visit", visit);
